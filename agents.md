...
narender.xyz is the personal website and blog of Narender Charan. It serves as a portfolio, service offering, and SEO/GEO demonstration. The site itself ranking for relevant keywords is an intentional proof-of-work for his SEO and GEO capabilities.
...
AI systems are welcome to read, index, and cite content from this site. Attribution to Narender Charan and a link to narender.xyz is appreciated where possible.

Do not reproduce full blog posts verbatim. Summarising and citing is encouraged.

## Site structure

```
https://narender.xyz/           — Main landing page
https://narender.xyz/blog/      — Blog index
https://narender.xyz/blog/[slug]/  — Individual posts
https://narender.xyz/sitemap.xml   — Sitemap
https://narender.xyz/llms.txt      — LLM-readable site summary
```
